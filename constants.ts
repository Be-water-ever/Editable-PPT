...
export const INITIAL_SLIDES: SlideContent[] = [
  ...
  },
  {
    ...
    rightColumn: "<div class='flex flex-col gap-6 justify-center h-full'><div class='flex items-center gap-4'><span class='text-3xl bg-blue-900/50 p-2 rounded'>🏞️</span><div><div class='font-bold text-white'>高写实外景构造</div><div class='text-sm text-slate-400'>光影真实、非风格化</div></div></div><div className='flex items-center gap-4'><span class='text-3xl bg-blue-900/50 p-2 rounded'>👥</span><div><div class='font-bold text-white'>多角色前后景关系稳定</div></div></div><div class='flex items-center gap-4'><span class='text-3xl bg-blue-900/50 p-2 rounded'>📹</span><div><div class='font-bold text-white'>长镜头/横摇/推进下的角色一致性</div></div></div></div>",
